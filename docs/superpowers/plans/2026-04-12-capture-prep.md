...
**Architecture:** Put pure preprocessing logic in a small helper module under `codes/`, keep the CLI thin, and stage all generated outputs under `./staging/`. Reuse the upstream pipeline concepts, but adapt timestamp handling and IMU splitting for the new raw format.
...
**Files:**
- Create: `codes/test_prepare_capture_lib.py`
- Create: `codes/prepare_capture_lib.py`
...
- [ ] Run: `.venv/bin/python codes/test_prepare_capture_lib.py`
- [ ] Verify the new tests fail for the expected missing-symbol reasons.

### Task 2: Implement Pure Helpers

**Files:**
- Modify: `codes/prepare_capture_lib.py`
- Test: `codes/test_prepare_capture_lib.py`
...
**Files:**
- Create: `codes/process_prepare_capture_batch.py`
- Modify: `codes/prepare_capture_lib.py`
- Test: `codes/test_prepare_capture_lib.py`
